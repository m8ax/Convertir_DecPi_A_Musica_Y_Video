...
#  Se Creará Un Fichero Midi, Otro Ogg Y Otro M4a, Con La Música De Los Decimales De PI.
...
#  La Duración De Cada Nota, Será De 0.2s.
...
#  Versión De Música Rápida De PI...
#  Ejemplo - py m8ax_pimusDEPRAP.py
#
####################################################################################################################################
...
with open("Pi_Dec.TxT", "r") as file:
    for line in file:
        for char in line:
            ...
            d = music21.duration.Duration(0.2)
...
nn = 0
framesize = ((1920), (1080))
outv = cv2.VideoWriter("M8AX-Video-Temporal.Mp4", cv2.VideoWriter_fourcc(*"h265"), 10, framesize)
print("")
